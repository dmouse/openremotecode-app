...
android {
    ...
    defaultConfig {
        ...
        applicationId = "com.openremotecode.app"
        if (integrationApp) {
            applicationIdSuffix = ".integration"
        }
        manifestPlaceholders["appLabel"] = if (integrationApp) "Open Remote Code tests" else "Open Remote Code"
    ...
    signingConfigs {
        if (hasReleaseSigning) {
            create("release") {
                // Resolve against android/, like key.properties, not android/app/.
